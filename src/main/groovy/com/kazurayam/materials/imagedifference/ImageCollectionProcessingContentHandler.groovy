...
interface ImageCollectionProcessingContentHandler {
    ...
    void endMaterialPair(TCaseName tCaseName, Material expectedMaterial, Material actualMaterial,
    ...
    void startMaterialPair(TCaseName tCaseName, Material expectedMaterial, Material actualMaterial,
            double criteriaPercentage) throws ImageDifferenceException
